...
namespace Render 
{
	namespace Shader
	{
		...
		class VtxStripLine :public BaseShaderData
		{
		public:
			void SetRendData(DATA_TYPE::VERTEXDATA* VtxData);
		...
		private:
			DATA_TYPE::VERTEXDATA* VerTexData;
			D3DXVECTOR4 Color;
			const char* VS_NOTex = "Shader\\VS_NoTexture.hlsl";
			const char* PS_NOTex = "Shader\\PS_NoTexture.hlsl";
		};
		...
		public:
			...
			void UpdateModel(DATA_TYPE::MFMMESHDATA* inData);
			void SetColor(D3DXVECTOR4 Color);
			void Draw();							
		private:
			...
			//const char* PS = "Shader\\PS_Phone_2.hlsl";
